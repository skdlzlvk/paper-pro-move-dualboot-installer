...
public final class QuickstepLauncher extends Activity {
    ...
    private void syncNativeLocale() {
        ...
        String locale = PaperLocale.isKorean(this) ? "ko\n" : "en\n";
    ...
    private final class PaperHomeView extends View {
        ...
        private void drawAppMark(Canvas canvas, Tile tile,
            ...
            iconStroke(Color.rgb(72, 72, 69), 2.5f);
        ...
        protected void onDraw(Canvas canvas) {
            ...
            final int line = Color.rgb(176, 174, 167);
            final int soft = Color.rgb(248, 248, 244);
            ...
            paint.setStyle(Paint.Style.FILL);
            paint.setColor(Color.rgb(205, 203, 196));
            ...
            for (int index = 0; index < appTiles.size(); index++) {
                ...
                surface(canvas, tile.bounds, Color.rgb(247, 247, 243));
            ...
            if (appTiles.isEmpty()) {
                ...
                surface(canvas, empty, Color.rgb(247, 247, 243));
            ...
            text(canvas, getString(R.string.stock_os_detail),
        ...
        private void performAction(int action) {
            switch (action) {
                ...
                case ACTION_WIFI:
                    ...
                    break;
                case ACTION_STORE:
                    Intent store = getPackageManager()
                            .getLaunchIntentForPackage("com.aurora.store");
                    if (store == null) {
                        Toast.makeText(QuickstepLauncher.this,
                                getString(R.string.aurora_not_found),
                                Toast.LENGTH_SHORT).show();
                        return;
                    }
                ...
                case ACTION_ALL_APPS:
                    ...
                    break;
                case ACTION_STOCK:
                    File stockRequest = new File(
                            getFilesDir(), "paper-stock-request");
                    try (FileOutputStream output =
                        ...
                        output.flush();
                        Toast.makeText(QuickstepLauncher.this,
                                getString(R.string.rebooting_stock),
                                Toast.LENGTH_SHORT).show();
